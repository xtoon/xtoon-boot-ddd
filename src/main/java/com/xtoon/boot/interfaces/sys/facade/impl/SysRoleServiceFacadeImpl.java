...
import com.xtoon.boot.application.RoleService;
...
import com.xtoon.boot.interfaces.sys.facade.SysRoleServiceFacade;
import com.xtoon.boot.interfaces.sys.facade.assembler.RoleDTOAssembler;
...
public class SysRoleServiceFacadeImpl implements SysRoleServiceFacade {
    ...
    public void saveOrUpdate(RoleDTO roleDTO) {
        roleService.saveOrUpdate(RoleDTOAssembler.toRole(roleDTO));
    }
    ...
    public void disable(String id) {
        roleService.disable(new RoleId(id));
    }
}
