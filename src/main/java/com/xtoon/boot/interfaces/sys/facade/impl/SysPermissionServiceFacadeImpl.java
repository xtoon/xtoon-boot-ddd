...
import com.xtoon.boot.interfaces.sys.facade.SysPermissionServiceFacade;
import com.xtoon.boot.interfaces.sys.facade.assembler.PermissionDTOAssembler;
...
public class SysPermissionServiceFacadeImpl implements SysPermissionServiceFacade {
    ...
    public void delete(String id) {
        permissionService.delete(new PermissionId(id));
    }

    @Override
    public void disable(String id) {
        permissionService.disable(new PermissionId(id));
    }
