...
import com.xtoon.boot.interfaces.sys.web.command.AccountLoginCommand;
import com.xtoon.boot.interfaces.sys.web.command.MobileLoginCommand;
...
public class SysLoginController extends AbstractController {
    ...
    public Result loginByMobile(@RequestBody MobileLoginCommand mobileLoginCommand) {
        ...
        String verificationCodeRedis = redisUtils.get(InterfacesConstant.REDIS_PHONE_CODE + mobileLoginCommand.getMobile());
