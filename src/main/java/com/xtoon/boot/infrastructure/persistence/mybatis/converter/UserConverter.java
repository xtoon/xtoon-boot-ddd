...
public class UserConverter {
    ...
    public static User toUser(SysUserDO sysUserDO) {
        Tenant tenant = new Tenant(new TenantId(sysUserDO.getTenantId()),new TenantCode(sysUserDO.getTenantCode()),new TenantName(sysUserDO.getTenantName()),StatusEnum.ENABLE,null);
        User user = new User(new UserId(sysUserDO.getId()), new UserName(sysUserDO.getUserName()), StatusEnum.getStatusEnum(sysUserDO.getStatus()),tenant,null);
        return user;
    }
